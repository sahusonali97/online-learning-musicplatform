                                            ...
                                            { cartData != null ? cartData.map((item,key)=>{
                                              ...
                                              return  <tr key={key}>
                                                    ...
                                                    <td className="pro-quantity">
                                                        <div className="pro-qty"><input type="text" value={(item.cartQty)} /><a className="inc qty-btn" onClick={(e) => { updateCartItmQty(e, 1,item); }}  >+</a><a  className="dec qty-btn" onClick={(e) => { updateCartItmQty(e, 2,item); }}>-</a></div>
                                                    </td>
