...
const VerifyOTPForgotPassword =(props)=>{
  ...
  const [isLoading, setLaoding] = useState(false);
    ...
    const {
      ...
      if(digittotal==4){
        setLaoding(true);
       Api.verifyForgotOTP(user_id,otp).then(
        (response)=>{
                ...
                alert.show(response.data.message, {
                    ...
                    */
                    onClose: () => {
                        ...
                        window.location.href = '/verify-password-confirm';
                      //console.log('closed')
                    } 
                });
