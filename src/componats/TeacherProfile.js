...
const TeacherProfile =(props)=>{
    ...
    const [teacherInsData,setTeacherInsData] = useState([]);
    const [toggleMenuData1,settoggleMenuData1] = useState(0); 
    const [toggleMenuData2,settoggleMenuData2] = useState(0); 
    const [toggleMenuData3,settoggleMenuData3] = useState(0); 

    const alert = useAlert()
 

    useEffect(()=>{
        Api.getTeacherById(teacherId).then(
            (response)=>{
              //  console.log(response.data.data);
                setTeacherData(response.data.data);
                setTeacherInsData(response.data.intrument)
	...
	}, [setTeacherData,setTeacherInsData]);
	...
	function toggleMenu(type){
        if(type==1){
            if(toggleMenuData1){
                settoggleMenuData1(0);
            }else{
                settoggleMenuData1(1);
            }
        }

        if(type==2){
            if(toggleMenuData2){
                settoggleMenuData2(0);
            }else{
                settoggleMenuData2(1);
            }
        }

        if(type==3){
            if(toggleMenuData3){
                settoggleMenuData3(0);
            }else{
                settoggleMenuData3(1);
            }
        }
                                ...
                                <div className="doctor-widget">
                                    <div className="doc-info-left">
                                        <div className="doctor-img">
                                            <img src={teacherData.image} className="img-fluid" alt="User Image"/>
                                        </div>
                                        <div className="doc-info-cont">
                                            <h4 className="doc-name">{teacherData.name}</h4>
                                            <p className="doc-speciality">{teacherData.about}</p>
                                    ...
                                    <div className="doc-info-right">
                                        ...
                                        <div className="doctor-action">
                                            ...
                                            <a href="https://wa.me/8886699622" target="_new" className="btn btn-white call-btn" data-toggle="modal" data-target="#voice_call">
                                        ...
                                        <Link  className="apt-btn" to="/find-classes"> 
                                        Book class
                                        </Link> 
                                ...
                                <nav className="user-tabs mb-4">
                                    <ul className="nav nav-tabs nav-tabs-bottom nav-justified">
                                        <li className="nav-item">
                                            <a className={`nav-link ` +(toggleMenuData1?'active':'')} href="#doc_overview" data-toggle="tab">Overview</a>
                                        </li>
                                        
                                        <li className="nav-item">
                                            <a className={`nav-link  ` +(toggleMenuData2?'active':'')} href="#doc_reviews" data-toggle="tab">Reviews</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className={`nav-link  ` +(toggleMenuData3?'active':'')} href="#doc_business_hours" data-toggle="tab">Business Hours</a>
                                        </li>
                                    </ul>
                                </nav>
                                                ...
                                                <div className="col-md-6">
                                                    <div className="clinic-content">
                                                        ...
                                                        <div className="clinic-details mb-0">
                                                            <h5 className="clinic-direction"> <i className="fas fa-map-marker-alt"></i> 2286 Sundown Lane, Austin, Texas 78749, USA <br/><a href="">Get Directions</a></h5>
                                                            <ul>
                                                                <li>
